...
a persistence unit "appMedicaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "appMedica/pom.xml":
...
artifact ("appMedica.war") is already built. You can build
